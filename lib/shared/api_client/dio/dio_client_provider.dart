...
import 'package:diagnostic_app/shared/api_client/dio/bad_certificate_fixer.dart';
import 'package:diagnostic_app/shared/api_client/dio/default_api_interceptor.dart';
import 'package:diagnostic_app/shared/api_client/dio/default_time_response_interceptor.dart';
import 'package:diagnostic_app/shared/api_client/dio/form_data_interceptor.dart';
...
final dioProvider = Provider.autoDispose<Dio>(
  (ref) {
    final dio = Dio();
    dio.options.baseUrl = 'https://sanitascare.health';
    if (kDebugMode) {
