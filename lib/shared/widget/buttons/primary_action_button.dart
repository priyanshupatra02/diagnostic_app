...
import 'package:diagnostic_app/shared/widget/custom_loaders/app_loader.dart';
    ...
    if (isIcon) {
      ...
      return ElevatedButton(
        ...
        child: <Widget>[
          if (isLoading)
            AppLoader(
              androidBgColor: AppColors.kSecondaryColor,
              iosBgColor: AppColors.kSecondaryColor,
            ),
          5.widthBox,
          Text(
            labelText,
